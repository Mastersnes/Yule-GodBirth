...
define(["jquery"], 
	...
	var data = {
			...
			"lune-1-event" : {
				...
				en :"For ages, Humanity has been attracted by his beauty and greatness.<br/>Getting closer and closer, but never being able to reach him. Will the Moon remain only a dream?"
			},
			...
			"lune-conquete2-event-help" : {
				...
				en :"Master, the new model ship is ready to take off! Thanks to your help, it's now more accurate and powerful.<br/>This time it's for sure, we will succeed!"
			},
			...
			"lune-conquete2-event-ko-2" : {
				...
				en :"Despite the many losses, the mission was a success. The Moon had been reached!<br/>Today, Humanity shone with his determination and perseverance. Nothing could stop him now."
			},
			...
			"lune-magie2-event" : {
				...
				en :"It's the Moon, my lord! It loses its strength! Soon, magic will no longer exist in the human world!"
			},
