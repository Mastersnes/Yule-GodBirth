...
define(["jquery"
	...
	var data = {
			...
			"lammas-frere-event" : {
				...
				en :"My God! Could you help me? It's my brother, he's missing! Please, answer my prayer!"
			},
			"lammas-frere-event-intervenir" : {
				...
				en :"Despite your efforts, you're unable to bring him back to life. His soul seemed to have dissipated..."
			},
			"lammas-frere-event-ignore" : {
				fr :"La prière se perdit dans le vide de l'espace ne trouvant jamais réponse...",
				en :"Prayer was lost in the void of space and never found an answer..."
			},
			...
			"lammas-frere2-event" : {
				...
				en :"Woman explained to you that her brother had simply dissipated before her eyes in a wonderful light."
			},
			...
			"lammas-frere2-event-laisser" : {
				...
				en :"Woman burst into tears. She knew that if you, you hadn't succeeded, no one could..."
			},
			...
			"lammas-disparition-event" : {
				...
				en :"An old man painfully entered into your palace. His empty gaze foreshadowed millennia of intense reflection..."
			},
			...
			"lammas-disparition3-event" : {
				...
				en :"A faint glow still persisted at the location where he was a few seconds earlier."
			},
			"lammas-disparition3-event-ignore" : {
				...
				en :"The glow finally fades out after a few seconds. You'll never know the real meaning of his intervention..."
			},
			...
			"lammas-disparition3-event-lumiere3" : {
				...
				en :"A voice calls out to you:<br/>Good morning, Great Everything. I know you well you know, you, the father of all things."
			},
			"lammas-disparition3-event-lumiere4" : {
				fr :"L'Univers existe grâce à votre bon vouloir et tourne selon vos pensées.",
				en :"Universe exists thanks to your goodwill and rotates according to your thoughts."
			},	
			...
			"lammas-disparition3-event-lumiere6" : {
				...
				en :"Your experience is coming to end. The divine thoughts that have shaped your world are gradually fading away, but don't be afraid..."
			},
			"lammas-disparition3-event-lumiere7" : {
				...
				en :"The accumulated energy will take shape somehow here and will forge a new Universe."
			},
			"lammas-disparition3-event-lumiere8" : {
				...
				en :"Will you be an actor or a puppet of this mechanism? Don't answer now...<br/>Answer simply in a fair way to the choices your Universe offers you. We'll meet again, great God..."
			},
			"lammas-disparition3-event-lumiere9" : {
				...
				en :"You open your eyes in your palace... You would never have thought that an entity could surpass the understanding of the gods."
			}
	};
