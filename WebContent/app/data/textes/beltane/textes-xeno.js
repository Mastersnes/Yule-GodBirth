...
define(["jquery"], 
	...
	var data = {
			...
			"xeno-1-event" : {
				fr : "Dans le vide de l'espace, au milieu du système solaire XL44H, un gigantesque voilier solaire démarre la procédure de décryogénisation.<br/>Sa mission : Analyser des signaux de vie dans le secteur...",
				en : "In the vacuum of space, in the middle of the XL44H solar system, a gigantic solar sailboat starts the decryogenization procedure.<br/>His mission: To analyze life signals in the area..."
			},
			...
			"xeno-2-event" : {
				fr : "Maître ! Nous sommes enfin opérationnel pour nos recherche. Mais différentes planètes sont visible sur nos radars. Laquelle devrions nous choisir ?",
			...
			"xeno-2-event-green" : {
				fr : "L’équipage mis le cap sur la planète verte... Sa surface, recouverte de végétation dense, laissait présagé une vie grouillante !",
			...
			"xeno-2-event-red" : {
				fr : "L’équipage mis le cap sur la planète rouge... Sa surface à priori aride laissait présagé un désert sans vie...",
			...
			"xeno-2-event-blue" : {
				fr : "L’équipage mis le cap sur la planète bleue... Son environnement apparemment exclusivement aquatique, laissait présagé une vie sous-marine abondante !",
			...
			"xeno-green-event" : {
				fr : "La planète était bel et bien verdoyante. Le vaisseau se posa difficilement dans une clairière, à l'abris des nombreux arbres environnants...",
			...
			"xeno-green-event-explorer2" : {
				fr : "Des forêt alentours sortirent des milliers de créatures humanoïdes. Elles semblaient primitive mais désireuse de communiquer.<br/>Une nouvelle air de paix et de partage commença.",
			...
			"xeno-red-event-explorer" : {
				fr : "L’équipage trouva de nombreuses ruines d'un passé florissant...<br/>Les anciennes gravures parlaient d'une grande catastrophe ayant annihilés toute vie sur la planète...",
			...
			"xeno-red-event-explorer2" : {
				fr : "Motivé par cette découverte, ils repartirent dans l'espace. Les autres planètes cacheraient certainement de merveilleux secrets...",
			...
			"xeno-espace-red-event" : {
				fr : "Maître ! Nous revoici en stationnement orbital. Deux planètes sont encore visible sur nos radars. Laquelle devrions nous choisir ?",
			...
			"xeno-bleu-event" : {
				fr : "Le bleu détecté dans les radar n’était malheureusement pas de l'eau et l’équipage ne le compris que trop tard...",
