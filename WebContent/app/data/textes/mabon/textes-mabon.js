...
define(["jquery"
	...
	var data = {
			...
			"mabon-start-event" : {
				...
				en :"We were there. The end of the Universe was very close... More and more living beings were dissipating to pure energy and some planets had even begun to disappear."
			},
			"mabon-start-event2" : {
				...
				en :"In the back of your palace, tired by a life of choice, you saw again in front of you this magnificent glow emerging from void.<br/>Your decision was taken. With a decided step, you entered into the light."
			},
			...
			"mabon-fin-good-event" : {
				...
				en :"So, you are here again among us, within the immaterial...<br/>The time has come, you know? Everything must find its place again in the great cycle..."
			},
			...
			"mabon-fin-good-event3" : {
				...
				en :"You reopen your eyes, sitting in your palace. Universe was still coming to end, but you were no longer worried about it..."
			},
			...
			"mabon-fin-bad-event2" : {
				...
				en :"I must confess that I'm surprised, your actions have been terrible and the new Universe that is preparing will be filled with hatred and terror..."
			},
			...
			"mabon-fin-bad-event4" : {
				...
				en :"You woke up with a start, sitting in your palace. Universe was still coming to end and you were worried about it..."
			},
			"mabon-fin-bad-event5" : {
				...
				en :"Things are in constant change, even the gods can do nothing about it...<br/>And despite all the efforts, things are getting worse from cycle to cycle."
			}
	};
