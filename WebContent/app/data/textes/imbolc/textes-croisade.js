...
define(["jquery"], function($){
	var data = {
			...
			"croisade-start-event" : {
				...
				en :"From all over the world, his name must resound! Fools and heretics who ignore his existence must be punished!"
			},
			...
			"croisade-benediction-event-accept" : {
				...
				en :"Thank you for your blessing, my God! We'll make your power reign in the Universe!"
			},
			...
			"croisade-attaques-event-tuer-village" : {
				...
				en :"Flames emerged from the infidel's villages, reducing the inhabitants to ashes. No one can go against divine acts!"
			},
			"croisade-attaques-event-tuer-soldat-button" : {
				fr :"Tuer les croisés",
				en :"Kill the crusaders"
			},
			...
			"croisade-attaques-event-stop" : {
				...
				en :"All the weapons disappeared in an instant. The crusaders, in the middle of the massacre, saw the wounded people heal under their eyes..."
			},
			...
			"croisade-graal-event" : {
				...
				en :"Master! Our scouts report a group of heretics are hiding in a secret cave... At least, until today!"
			},
			...
			"croisade-graal-event-ensevelir" : {
				fr :"Les sages hérétiques furent enterrés vivants dans la grotte... Leurs secrets avec eux...",
				en :"The wise heretics were buried alive in the cave... Their secrets with them..."
			},
			...
			"croisade-graal-event-laisser" : {
				fr :"Les croisés s'en allèrent, laissant la grotte intacte.<br/>On perdit toute trace des hérétiques...",
				en :"The crusaders went away, leaving the cave intact.<br/>All traces of heretics were lost..."
			}
	};
