...
define(["jquery"], function($){
	var data = {
			...
			"accueil-pluie-event-ok" : {
				...
				en :"Ohh, thanks my God! Thanks to you, we'll be able to survive a few years more. Thanks a lot!"
			},
			...
			"accueil-question-event-ko" : {
				...
				en :"Yes... That's just what I thought..."
			}
	};
