	...
	var data = {
			...
			"dieu" : new function() {
			    ...
			    this.gain = function (incr, ameliorations) {
	        		...
	        		var croyance = Math.round(me * 2);
	        		var mal = Math.round(Utils.pow(2, lvl, 0.7));
	        		var illumination = 0;
	        		var bien = 0;
			...
			"deesse" : new function() {
				...
				this.prix = function (lvl) {
                    if(!lvl) lvl = this.level;
					return {
						croyance : Math.round(Utils.pow(5, lvl, 2.85)),
			    ...
			    this.gain = function (incr, ameliorations) {
	        		...
	        		var croyance = Math.round(1.5 * me);
	        		...
	        		return {
	        			...
	        			click : {
	        				croyance : Math.round(0.25 * croyance),
	        				illumination : Math.round(0.25 * illumination),
            ...
            "terre" : new function() {
                ...
                this.gain = function (incr, ameliorations) {
	        		...
	        		var croyance = Math.round(3 * me);
	        		var bien = -Math.round(me * 0.2);
	        		var mal = Math.round(Utils.pow(3, lvl, 0.6));
	        		var illumination = 0;
            ...
            "lune" : new function() {
                ...
                this.prix = function (lvl) {
                    if(!lvl) lvl = this.level;
                    return {
						croyance : Math.round(Utils.pow(300, lvl, 2.02)),
                ...
                this.gain = function (incr, ameliorations) {
	        		...
	        		var croyance = Math.round(me * 2.5);
	        		...
	        		return {
	        			...
	        			click : {
	        				...
	        				illumination : Math.round(illumination * 0.25),
            ...
            "soleil" : new function() {
                ...
                this.prix = function (lvl) {
                    if(!lvl) lvl = this.level;
                    return {
                    	croyance : Math.round(Utils.pow(700, lvl, 1.8)),
                ...
                this.gain = function (incr, ameliorations) {
	        		...
	        		var illumination = Math.round(me / 16);
	        		var mal = Math.round(Utils.pow(5, lvl, 0.7));
	        		var bien = 0;
            ...
            "ciel" : new function() {
                ...
                this.prix = function (lvl) {
                    if(!lvl) lvl = this.level;
                    return {
                    	croyance : Math.round(Utils.pow(7000, lvl, 1.4)),
            ...
            "foret" : new function() {
                ...
                this.prix = function (lvl) {
                    if(!lvl) lvl = this.level;
                    return {
                    	croyance : Math.round(Utils.pow(7500, lvl, 1.38)),
                ...
                this.gain = function (incr, ameliorations) {
	        		...
	        		var croyance = Math.round(me * 2.5);
	        		var illumination = Math.round(me / 6);
            ...
            "ocean" : new function() {
                ...
                this.gain = function (incr, ameliorations) {
	        		...
	        		var croyance = Math.round(me * 3.3);
            ...
            "vide" : new function() {
                ...
                this.prix = function (lvl) {
                    if(!lvl) lvl = this.level;
                    return {
                    	croyance : Math.round(Utils.pow(5000, lvl, 1.55)),
                ...
                this.gain = function (incr, ameliorations) {
	        		...
	        		var croyance = Math.round(me * 1.5);
	        		var illumination = Math.round(me / 5);
            ...
            "chaos" : new function() {
                ...
                this.prix = function (lvl) {
                    if(!lvl) lvl = this.level;
                    return {
                    	croyance : Math.round(Utils.pow(15000, lvl, 1.2)),
                ...
                this.gain = function (incr, ameliorations) {
	        		...
	        		var croyance = Math.round(me * 5);
	        		var illumination = Math.round(me / 17);
            ...
            "abysse" : new function() {
                ...
                this.prix = function (lvl) {
                    if(!lvl) lvl = this.level;
                    return {
                    	croyance : Math.round(Utils.pow(8000, lvl, 1.4)),
                ...
                this.gain = function (incr, ameliorations) {
	        		...
	        		var croyance = Math.round(me * 4.2);
	        		var bien = -Math.round(me * 1.3);
	        		var mal = Math.round(me * 2.5);
	        		var illumination = 0;
            ...
            "amour" : new function() {
                ...
                this.prix = function (lvl) {
                    if(!lvl) lvl = this.level;
                    return {
                    	croyance : Math.round(Utils.pow(33333, lvl, 1.16)),
            ...
            "connaissance" : new function() {
                ...
                this.prix = function (lvl) {
                    if(!lvl) lvl = this.level;
                    return {
                    	croyance : Math.round(Utils.pow(66666, lvl, 1.01)),
                ...
                this.gain = function (incr, ameliorations) {
	        		...
	        		var croyance = Math.round(me * 5.6);
            ...
            "evolution" : new function() {
                ...
                this.prix = function (lvl) {
                    if(!lvl) lvl = this.level;
                    return {
                    	croyance : Math.round(Utils.pow(99999, lvl, 0.92)),
